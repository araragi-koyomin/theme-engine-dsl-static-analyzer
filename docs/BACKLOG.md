...
| M4 | 语义分析 | in-progress | 9 Analyzer + DiagnosticProvider 模式分发(P0) + **FIX002: `@` 跳过 + buildUndefinedElementRefDiagnostic 编译断裂** | [→](architecture/M4-SemanticAnalysis.md) |
...
| 分支 | 描述 | PR |
|---|---|---|
| fix/FIX002-undefined-str-ref | 未定义 string 变量引用不报错 + 编译断裂 | 待创建 |

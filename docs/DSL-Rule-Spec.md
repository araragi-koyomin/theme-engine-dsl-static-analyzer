...
### 5.1 XML结构语法错误（dom4j解析阶段捕获）

| 规则ID | 检测内容 | 检测机制 | 严重级别 |
|---|---|---|---|
| SYN-001 | XML标签未闭合 | dom4j SAXParseException包装 | error |
| SYN-003 | 属性引号缺失 | dom4j SAXParseException包装 | error |
| SYN-009 | 缺少XML声明头 | dom4j解析阶段检测 | warning |
